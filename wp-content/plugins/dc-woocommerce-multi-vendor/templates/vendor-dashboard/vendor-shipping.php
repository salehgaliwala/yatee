    ...
    <form name="vendor_shipping_form" class="wcmp_shipping_form form-horizontal" method="post">
        ...
        <div class="panel panel-default panel-pading pannel-outer-heading">
            <div class="panel-heading d-flex">
                <h3><?php esc_html_e('Zones d\'expédition', 'dc-woocommerce-multi-vendor'); ?></h3>
            </div>
            <div class="panel-body">
                <div id="wcmp_settings_form_shipping_by_zone" class="wcmp-content shipping_type by_zone hide_if_shipping_disabled">
                    <table class="table wcmp-table shipping-zone-table">
                        <thead>
                            <tr>
                                <th><?php esc_html_e('Nom de zone', 'dc-woocommerce-multi-vendor'); ?></th> 
                                <th><?php esc_html_e('Région', 'dc-woocommerce-multi-vendor'); ?></th> 
                                <th><?php esc_html_e('Mode de livraison', 'dc-woocommerce-multi-vendor'); ?></th>
                                        ...
                                        <td>
                                            <div class="wcmp-shipping-zone-methods">
                                                ...
                                                if (empty($vendor_shipping_methods)) {
                                                    ?>
                                                    <span><?php esc_html_e('Aucune méthode d\'expédition n\'est offerte dans cette zone.', 'dc-woocommerce-multi-vendor'); ?> </span>
                                                <?php } else { ?>
