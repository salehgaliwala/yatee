...
<div class="panel panel-default panel-pading pannel-outer-heading cust-refund-request">
    <div class="panel-heading d-flex">
        <h3><?php _e('Demande de remboursement client', 'dc-woocommerce-multi-vendor'); ?></h3>
    </div>
    <div class="panel-body panel-content-padding">
        ...
        <div class="form-group mb-0">
            ...
            $refund_statuses = array( 
                '' => __( 'Statut de remboursement','dc-woocommerce-multi-vendor' ),
                'refund_request' => __( 'Remboursement demandé', 'dc-woocommerce-multi-vendor' ), 
                'refund_accept' => __( 'Remboursement accepté','dc-woocommerce-multi-vendor' ), 
                'refund_reject' => __( 'Remboursement rejeté','dc-woocommerce-multi-vendor' ) 
            );
            ?>
