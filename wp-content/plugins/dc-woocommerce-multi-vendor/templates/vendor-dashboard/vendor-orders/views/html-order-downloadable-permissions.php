...
<div class="panel panel-default panel-pading pannel-outer-heading download-product-permission">
    <div class="panel-heading d-flex">
        <h3><?php esc_html_e('Autorisations de produit téléchargeables', 'dc-woocommerce-multi-vendor'); ?></h3>
    </div>
    <div class="order_download_permissions wc-metaboxes-wrapper panel-body panel-content-padding">
        ...
        <div class="toolbar">
            <div class="form-group mb-0">
                ...
                <button class="button grant_access btn btn-default"><?php esc_html_e('Autoriser l\'accès', 'dc-woocommerce-multi-vendor'); ?></button>
            </div>
        </div>
    </div>
</div>