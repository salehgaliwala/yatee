        ...
        if (apply_filters('is_vendor_can_view_order_notes', true, $vendor->id)) {
            ...
            <ul class="order_notes list-group mb-0">
                ...
                <li class="list-group-item list-group-item-action flex-column align-items-start">
                    <button type="button" class="btn btn-default" data-toggle="collapse" data-target="#shipping_tracking_wrap"><?php _e('Suivi de commande', 'dc-woocommerce-multi-vendor'); ?></button>
                </li>
