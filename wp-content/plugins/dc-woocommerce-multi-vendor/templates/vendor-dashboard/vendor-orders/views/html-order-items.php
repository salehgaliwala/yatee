...
<div class="wcmp_order_items_wrapper panel panel-default panel-pading pannel-outer-heading order-detail-table-wrap">
    <div class="panel-heading d-flex">
        <h3><?php _e('Articles', 'dc-woocommerce-multi-vendor'); ?></h3>
    </div>
    <div class="panel-body">
        <div class="single-order-detail-table">
            <table class="woocommerce_order_items table">
                <thead>
                    <tr>
                        <th colspan="2"><?php esc_html_e('Article', 'dc-woocommerce-multi-vendor'); ?>:</th>
                        <?php do_action('wcmp_vendor_dash_order_item_headers', $order); ?>
                        <th><?php esc_html_e('Coût', 'dc-woocommerce-multi-vendor'); ?></th>
                        <th><?php esc_html_e('Qté', 'dc-woocommerce-multi-vendor'); ?></th>
                        <th><?php esc_html_e('Totale', 'dc-woocommerce-multi-vendor'); ?></th>
                        <?php
                        ...
                        <td colspan="7">
                            <div class="wcmp-order-totals-items wc-order-items-editable">
                                ...
                                <table class="wcmp-order-totals">
                                    ...
                                    <?php if (0 < $order->get_total_discount()) : ?>
                                        <tr>
                                            <td class="label"><?php esc_html_e('Remise:', 'dc-woocommerce-multi-vendor'); ?></td>
                                            <td width="1%"></td>
                                            <td class="total">
                                    ...
                                    <tr>
                                        <td class="label"><?php esc_html_e('Total gagné', 'dc-woocommerce-multi-vendor'); ?>:</td>
                                        <td width="1%"></td>
                                        <td class="total">
                            ...
                            <div class="wcmp-order-actions  wcmp-order-data-row-toggle">
                                ...
                                <?php if( $order->get_status( 'edit' ) != 'cancelled' ) : ?>
                                    <button type="button" class="button refund-items btn btn-default"><?php esc_html_e('Remboursement', 'dc-woocommerce-multi-vendor'); ?></button>
                                <?php endif; ?>
                                <?php endif; ?>
                                <?php
                                ...
                                <div class="wcmp-order-refund-items wcmp-order-data-row-toggle" style="display: none;">
                                    <table class="wc-order-totals pull-right">
                                        <?php if ('yes' === get_option('woocommerce_manage_stock')) : ?>
                                            <tr>
                                                <td class="label"><label for="restock_refunded_items"><?php esc_html_e('Réapprovisionner les articles remboursés', 'dc-woocommerce-multi-vendor'); ?>:</label></td>
                                        ...
                                        <?php endif; ?>
                                        <tr>
                                            <td class="label"><?php esc_html_e('Montant déjà remboursé', 'dc-woocommerce-multi-vendor'); ?>:</td>
                                            <td class="total">-<?php echo wc_price($order->get_total_refunded(), array('currency' => $order->get_currency())); // WPCS: XSS ok.   ?></td>
                                        </tr>
                                        <tr>
                                            <td class="label"><?php esc_html_e('Total disponible pour remboursement', 'dc-woocommerce-multi-vendor'); ?>:</td>
                                        ...
                                        <tr>
                                            <td class="label"><label for="refund_amount"><?php esc_html_e('Montant du remboursement', 'dc-woocommerce-multi-vendor'); ?>:</label></td>
                                            <td class="total">
                                        ...
                                        <tr>
                                            <td class="label"><label for="refund_reason"><?php echo wc_help_tip(__('Remarque : le motif du remboursement sera visible par le client.', 'dc-woocommerce-multi-vendor')); ?> <?php esc_html_e('Motif du remboursement (facultatif):', 'dc-woocommerce-multi-vendor'); ?></label></td>
                                            <td class="total">
