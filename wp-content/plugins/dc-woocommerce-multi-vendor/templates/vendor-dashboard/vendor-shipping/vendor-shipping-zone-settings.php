...
<div class="zone-component panel-content-padding">
	<div class="shipping-zone-list">
		<a href="javascript:void(0);" ><i class="wcmp-font ico-back-arrow"></i> <?php  esc_html_e('Zones d\'expédition', 'dc-woocommerce-multi-vendor'); ?></a>
		<hr>
	</div>
	<div class="form-group"> 
		<label class="control-label col-sm-3 col-md-3"><?php esc_html_e('Nom de zone', 'dc-woocommerce-multi-vendor'); ?></label>
		<div class="col-md-6 col-sm-9"><?php echo esc_attr($zones['data']['zone_name']); ?></div>
	</div>
	<div class="form-group"> 
		<label class="control-label col-sm-3 col-md-3"><?php esc_html_e('Zone zone', 'dc-woocommerce-multi-vendor'); ?></label>
	...
	<?php if( $show_limit_location_link && $zone_id !== 0 ) { ?>
		<div class="form-group">
		   	<label for="" class="control-label col-sm-3 col-md-3"><?php esc_html_e( 'Emplacement de la zone limite', 'dc-woocommerce-multi-vendor' ); ?></label>
		   	<div class="col-md-6 col-sm-9">
			...
			<table class="table wcmp-table zone-method-table table-bordered">
				<thead>
					<tr>
						...
						<th class="enabled"><?php esc_html_e('Activé', 'dc-woocommerce-multi-vendor'); ?></th> 
						<th class="description"><?php esc_html_e('La description', 'dc-woocommerce-multi-vendor'); ?></th>
