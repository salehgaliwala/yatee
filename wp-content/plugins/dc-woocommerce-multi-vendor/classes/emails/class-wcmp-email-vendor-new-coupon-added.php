...
if (!class_exists('WC_Email_Vendor_New_Coupon_Added')) :
     ...
     *
     * @class 		WC_Email_Vendor_New_Coupon_Added
     * @version		2.0.0
     * @package		WooCommerce/Classes/Emails
     * @author 		WooThemes
     * @extends 	WC_Email
     */
    class WC_Email_Vendor_New_Coupon_Added extends WC_Email {
        ...
        function __construct() {
            ...
            $this->id = 'admin_new_vendor_coupon';
            ...
            $this->heading = __('New coupon submitted: {coupon_name}', 'dc-woocommerce-multi-vendor');
            $this->subject = __('[{blogname}] New coupon submitted by {vendor_name} - {coupon_name}', 'dc-woocommerce-multi-vendor');

            $this->template_base = $WCMp->plugin_path . 'templates/';
            $this->template_html = 'emails/new-coupon.php';
            $this->template_plain = 'emails/plain/new-coupon.php';
        ...
        public function get_default_subject() {
            return apply_filters('wcmp_admin_new_vendor_coupon_email_subject', __('[{blogname}] New coupon submitted by {vendor_name} - {coupon_name}', 'dc-woocommerce-multi-vendor'), $this->object);
        }
        ...
        public function get_default_heading() {
            return apply_filters('wcmp_admin_new_vendor_coupon_email_heading', __('New coupon submitted: {coupon_name}', 'dc-woocommerce-multi-vendor'), $this->object);
        }
