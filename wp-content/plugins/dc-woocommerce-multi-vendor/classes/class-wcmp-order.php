...
//                        }
    ...
    public function wcmp_order_customer_refund_dd(){
        ...
        <button type="submit" class="button cust-refund-status button-default" name="cust_refund_status" value="<?php echo __('Sauvegarder', 'dc-woocommerce-multi-vendor'); ?>"><?php echo __('Sauvegarder', 'dc-woocommerce-multi-vendor'); ?></button>
        <script>
