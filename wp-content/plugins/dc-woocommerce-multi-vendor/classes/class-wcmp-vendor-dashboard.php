            ...
            if (!empty($wcmp_vendor_followed_by_customer)) {
                ...
                <div class="panel panel-default pannel-outer-heading">
                    <div class="wcmp-widget-dt table dataTable dtr-inline">
                        <div class="col-md-12 wcmp-comments dash-widget-dt"> <?php esc_html_e('Aucun client ne vous suit jusqu\'à présent.', 'dc-woocommerce-multi-vendor'); ?>
                        </div>
                    </div>
                </div>
                <?php            
    ...
    public function save_product() {
        ...
        if ( $_SERVER['REQUEST_METHOD'] === 'POST' ) { 
            ...
            if ( $post_id && ! is_wp_error( $post_id ) ) {
                ...
                do_action('wcmp_after_post_update',$post_id, $_POST);
