...
jQuery(document).ready(function ($) {
	...
	bacolaThemeModule.infinitescroll = function() {
		...
		$(window).data('ajaxready', true).scroll(function(e) {
			...
			if($(window).scrollTop() >= $('.woocommerce .site-primary .products:not(.klb-category-wrapper)').offset().top + $('.woocommerce .site-primary .products:not(.klb-category-wrapper)').outerHeight() - window.innerHeight) {
