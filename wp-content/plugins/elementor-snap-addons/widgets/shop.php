...
class Shop extends Widget_Base {
    ...
    public function get_title() {
        return __( 'Shop Carousel', 'elementor-banner' );
    }
    ...
    protected function _register_controls() {
        ...
        $this->add_control(
			'list',
			[
				'label' => __( 'Product List', 'plugin-domain' ),
				'type' => \Elementor\Controls_Manager::REPEATER,
				'fields' => $repeater->get_controls(),
				'default' => [
					[
						'product_name' => __( 'Preoduct Name.', 'plugin-domain' ),
                        'product_price' => __( 'Preoduct Name.', 'plugin-domain' ),
					],
					[
						'product_name' => __( 'Preoduct Name.', 'plugin-domain' ),
						'product_price'  => __( 'Product Name.', 'plugin-domain' ),
					],
				],
