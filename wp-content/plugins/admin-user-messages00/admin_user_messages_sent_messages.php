...
function admin_user_messages_sent_messages($content) {
    ...
    */
	...
	$resultPageingObject = $wpdb->get_results($queryPageingObject);
	$num_rowsPageingObject = $resultPageingObject->num_rows;
?>
	...
	<table border="0" cellpadding="0" cellspacing="0" width="100%">
	    	...
	    	<tr>
			<td><a href="<?php echo 'http://' . $aum_btn_back_to_inbox; ?>"><?php echo $aum_term_link_inbox; ?></a> | <a href="<?php echo 'http://' . $aum_btn_post_message; ?>"><?php echo $aum_term_link_post_a_message; ?></a> | <span class="nav_strong"><?php echo $aum_term_link_sent_messages; ?></span></td>
